...
<!-- sidebar start -->
<div class="admin-sidebar am-offcanvas" id="admin-offcanvas" hidden>
    <div class="am-offcanvas-bar admin-offcanvas-bar" hidden>
        <ul class="am-list admin-sidebar-list" hidden>
